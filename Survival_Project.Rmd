...
Last names can help us identify passengers according to which families they come from. Therefore, I will be cleaning the name variable by removing different name titles such as "Mr"and "Mrs" that are built in this name vector already. Also, the name variable seem to have "rare" titles, so I will be replacing those with something ubiquitous.
...
we see that we have 18 different titles but we will want to normalize these a bit so that we can generalize a bit more.
