...
And as expected, the larger the family gets the less likely it becomes for an individual to survive.
...
A lot is happening here, but it is clear that the `Female` sex was unlikely to survive especially for female aged between 20-40 years old. This can be due to a lot of factors such as that mothers might have been more vulnerable because they were caring for their children, so they were more likely to die. On the male side, it is understandable that males aged `20-40` were more likely to survive compared to males in other age groups.
...
To make it more interesting, I am going to create a `Mother` and `Child` variable to see whether being a mother or child is associated to survival.
